...
describe("streaming API route proxy", () => {
  ...
  it.each([
    ...
    const base = { id: "33333333-3333-4333-8333-333333333333", job_id: "11111111-1111-4111-8111-111111111111", revision: 1, classes: [{ id: "22222222-2222-4222-8222-222222222222", yolo_index: 0, name: "Araç", color: "#ff0000" }], images: [{ index: 4, filename: "one.jpg", width: 640, height: 360, timestamp_ms: 1000, completed: false, box_count: 0, preview_url: "/api/v1/jobs/11111111-1111-4111-8111-111111111111/annotations/images/4/preview" }], page: 1, page_size: 100, total_images: 1, limits: { max_classes: 100, max_boxes_per_image: 200, max_boxes_per_project: 50000 } };
